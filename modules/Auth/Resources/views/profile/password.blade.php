<x-app-layout>
            ...
            <form action="{{ route('user-password.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="mb-3">
                            <label class="col-form-label text-capitalize mx-2" for="new_password">
                                @localize('New Password')
                            </label>
                            <div class="form-input mb-3 position-relative">
                                <input class="form-control input-py @error('password') is-invalid @enderror"
                    ...
                    <div class="col-md-12 pt-5">
                        <button class="btn btn-primary input-py"> @localize('Update')</button>
                    </div>
                </div>
            </form>
        </x-auth::setting>
    ...
    @push('js')
        <script src="{{ module_asset('Auth/js/password.min.js') }}"></script>
    @endpush
</x-app-layout>
