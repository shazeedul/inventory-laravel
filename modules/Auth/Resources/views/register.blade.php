    ...
    <x-auth::card>
        <div>
            <div class="text-center mb-3">
                <x-auth::logo />
                <h3 class="fs-24">@localize('Welcome to') {{ setting('site.name') }}</h3>
            ...
            <form class="register-form validate text-left" method="POST" action="{{ route('register') }}">
                ...
                <div class="mb-3 ">
                    ...
                    <input type="text" class="form-control input-py @error('name') is-invalid @enderror"
                        id="name" name="name" placeholder="@localize('Enter name')" required autocomplete="name">
                ...
                <div class="mb-3">
                    ...
                    <div class="form-input mb-3 position-relative">
                        <input class="form-control input-py @error('password') is-invalid @enderror" type="password"
                            name="password" id="password" placeholder="@localize('Password')" required>
                ...
                <div class="mb-3">
                    ...
                    <div class="form-input mb-3 position-relative">
                        <input class="form-control input-py @error('password_confirmation') is-invalid @enderror"
                            type="password" name="password_confirmation" id="password2" placeholder="@localize('Password')"
                            required>
                        <!-- Password Show and Hide-->
                        <div class="password-showHide">
                            <svg class="icon show-password" width="18" height="18" fill="none"
                ...
                <button type="submit" class="btn btn-primary me-2 mb-2 mb-md-0 text-white">@localize('Create Account')</button>
            </form>
