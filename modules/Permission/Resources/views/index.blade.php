<x-app-layout>
        ...
        <x-slot name='actions'>
            <a href="javascript:void(0);" class="btn btn-primary btn-sm"
                onclick="axiosModal('{{ route(config('theme.rprefix') . '.create') }}')"><i
                    class="fa fa-plus-circle"></i>&nbsp;@localize('Add New Permission')</a>
        </x-slot>
    ...
    <div id="page-axios-data" data-table-id="#permission-table"></div>
    @push('lib-styles')
    ...
    @endpush
    @push('js')
        <script src="{{ module_asset('Permission/js/app.min.js') }}"></script>
    @endpush
</x-app-layout>
