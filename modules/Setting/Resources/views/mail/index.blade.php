                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control " id="MAIL_HOST" name="MAIL_HOST"
                            placeholder="@localize('Mail Host Name')" value="{{ $data['MAIL_HOST'] ?? old('MAIL_HOST') }}">
                        @error('MAIL_HOST')
                            <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="number" class="form-control arrow-hidden" id="MAIL_PORT" name="MAIL_PORT"
                            placeholder="@localize('Mail Port Number')" value="{{ $data['MAIL_PORT'] ?? old('MAIL_PORT') }}">
                        @error('MAIL_PORT')
                            <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                    ...
                    <div class="form-group mb-3">
                        ...
                        <div class="form-group">
                            <input type="text" class="form-control " id="MAIL_FROM_ADDRESS" name="MAIL_FROM_ADDRESS"
                                placeholder="@localize('Sender Email Address')"
