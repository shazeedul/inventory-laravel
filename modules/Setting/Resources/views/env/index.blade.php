                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="text" class="form-control " id="APP_NAME" name="APP_NAME"
                            placeholder="@localize('System Name')" value="{{ $data['APP_NAME'] ?? old('APP_NAME') }}">
                        @error('APP_NAME')
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        ...
                        <input type="url" class="form-control " id="APP_URL" name="APP_URL"
                            placeholder="@localize('System Site Url')" value="{{ $data['APP_URL'] ?? old('APP_URL') }}">
                        @error('APP_URL')
                            <span class="text-danger" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="APP_DEBUG">@localize('System App Debug')</label>
                                </div>
                                @error('APP_DEBUG')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                <div class="form-check form-switch">
                                    ...
                                    <label class="form-check-label" for="FORCE_HTTPS">@localize('System Force Https')</label>
                                </div>
                                @error('FORCE_HTTPS')
                                    <span class="text-danger" role="alert">
                                        <strong>{{ $message }}</strong>
