    ...
    <div class="row">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                @switch($setting->type)
                                    ...
                                    @case('email')
                                        <input id="{{ $setting->key }}" class="form-control" type="email"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('number')
                                        <input id="{{ $setting->key }}" class="form-control" type="number"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" step="any"
                                            @if (array_key_exists('min', $setting->details)) min="{{ $setting->details['min'] }}" @endif
                                            @if (array_key_exists('max', $setting->details)) max="{{ $setting->details['max'] }}" @endif />
                                    @break

                                    @case('date')
                                        <input id="{{ $setting->key }}" class="form-control" type="date"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('month')
                                        <input id="{{ $setting->key }}" class="form-control" type="month"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('week')
                                        <input id="{{ $setting->key }}" class="form-control" type="week"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('datetime')
                                        <input id="{{ $setting->key }}" class="form-control" type="datetime"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('time')
                                        <input id="{{ $setting->key }}" class="form-control" type="time"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('url')
                                        <input id="{{ $setting->key }}" class="form-control" type="url"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('tel')
                                        <input id="{{ $setting->key }}" class="form-control" type="tel"
                                            placeholder="Setting {{ $setting->display_name }}"
                                            name="data[{{ $setting->id }}]" id="data[{{ $setting->id }}]"
                                            value="{{ $setting->value }}" />
                                    @break
                                    ...
                                    @case('select_dropdown')
                                        <select class="select2 form-control" name="data[{{ $setting->id }}]"
                                            ...
                                            @if ($setting->value == null || $setting->value == '')
                                                <option disabled selected>{{ ___('Please Select one') }}</option>
                                            @endif
        ...
        @if (count($settings) > 0)
            <div class="d-flex justify-content-end mt-5">
                <button type="submit" class="btn btn-primary">@localize('Save Settings')</button>
            </div>
        @endif
        {{-- --}}
    </form>
