            ...
            <div class="row">
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        <label for="INVISIBLE_RECAPTCHA_SITEKEY">@localize('Recaptcha Site Key')</label>
                        <input type="text" class="form-control " id="INVISIBLE_RECAPTCHA_SITEKEY"
                            name="INVISIBLE_RECAPTCHA_SITEKEY" placeholder="@localize('Recaptcha Site Key')"
                ...
                <div class="col-12">
                    <div class="form-group mb-3">
                        <label for="INVISIBLE_RECAPTCHA_SECRETKEY">@localize('Recaptcha Secret Key')</label>
                        <input type="text" class="form-control " id="INVISIBLE_RECAPTCHA_SECRETKEY"
                            name="INVISIBLE_RECAPTCHA_SECRETKEY" placeholder="@localize('Recaptcha Secret Key')"
