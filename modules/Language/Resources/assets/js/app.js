$(document).ready(function () {
    ...
    var table = $("#local-builder-table").DataTable({
        ...
        columns: [
            {
                ...
                //     return type === "display"
                //         ? `<div contenteditable="true" class="editable-key" data-key="${row.key}" data-value="${row.value}">` +
                //               data +
                //               "</div>"
                //         : data;
                // },
        ...
        buttons: [
            {
                extend: "reset",
                className: "btn btn-primary box-shadow--4dp btn-sm-menu",
            },
            {
                extend: "reload",
                className: "btn btn-primary box-shadow--4dp btn-sm-menu",
...
function addNewLocalRow() {
    ...
    var btn = "";
    if (tr_count <= 1) {
        btn = `<button class="btn btn-primary btn-sm" onclick="addNewLocalRow()" type="button">
