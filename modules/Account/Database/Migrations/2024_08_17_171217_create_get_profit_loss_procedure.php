...
return new class extends Migration
{
    ...
    {
        DB::unprepared("
            CREATE PROCEDURE GetProfitLoss(
                IN start_date DATE,
                IN end_date DATE
            )
            BEGIN
                ...
                accounts_loop: LOOP
                    ...
                    INSERT INTO temp_table_pl (nature_id, nature_name, group_id, group_name, sub_group_id, sub_group_name, ledger_id, chart_of_account_name, debit, credit)
    ...
    {
        DB::statement('DROP PROCEDURE IF EXISTS GetProfitLoss');
    }
};
