...
return new class extends Migration
{
        ...
        DB::unprepared("
            ...
            BEGIN
                ...
                accounts_loop: LOOP
                    ...
                    INSERT INTO temp_table_bs (nature_id, nature_name, group_id, group_name, sub_group_id, sub_group_name, ledger_id, chart_of_account_name, debit, credit)
    ...
    {
        DB::statement('DROP PROCEDURE IF EXISTS GetBalanceSheet');
    }
};
