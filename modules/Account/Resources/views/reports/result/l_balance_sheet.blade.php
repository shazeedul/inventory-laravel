        ...
        <div class="table-responsive">
            <table class="table display table-bordered table-striped table-hover align-middle">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><strong>@localize('Total Liabilities And Share Equity')</strong></td>
                        <td>0.00</td>
                        <td><strong>{{ $liabilityBalance + $shareEquityBalance }}</strong></td>
                        @foreach ($lastThreeYears as $year)
                            <td>0.00</td>
                            <td><strong>{{ $liabilities->sum('year_balance_' . $year->name) + $shareEquities->sum('year_balance_' . $year->name) }}</strong>
                            </td>
                        @endforeach
                    </tr>
                </tbody>
