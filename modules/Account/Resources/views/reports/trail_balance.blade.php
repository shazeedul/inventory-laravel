            ...
            <div class="card">
                <div class="card-header">
                    <div class="d-flex justify-content-between align-items-center">
                        <div>
                            <h6 class="fs-17 fw-semi-bold mb-0">{{ localize('Trail Balance') }}</h6>
                        </div>
                                            ...
                                            <div class="d-flex flex-wrap">
                                                <div class="form-check form-check-inline mr-2">
                                                    ...
                                                    <label class="form-check-label"
                                                        for="full">{{ localize('Full') }}</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="as_on" value="as_on" />
                                                    <label class="form-check-label"
                                                        for="as_on">{{ localize('As On') }}</label>
                                                </div>
                                                <div class="form-check form-check-inline">
                                                    <input class="form-check-input" type="radio" name="type"
                                                        id="periodic" value="periodic" />
                                                    <label class="form-check-label"
                                                        for="periodic">{{ localize('Periodic') }}</label>
                                                </div>
                                            </div>
                                        </div>
        ...
        <script>
            $(function() {
                ...
                $('#filter').on('click', function(event) {
                    ...
                    axios.post('/admin/account/report/trail-balance', {
