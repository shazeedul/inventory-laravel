<x-app-layout>
    <x-card>
        ...
        <div>
            <form action="{{ route('admin.account.voucher.credit.store') }}" method="post">
                @csrf
                ...
                <table class="table table-bordered table-hover" id="creditAccVoucher">
                    ...
                    <tbody id="creditVoucher">
                        <tr>
                            <td>
                                <select name="credits[0][coa_id]" class="form-control select2"
                            ...
                            <td>
                                <select name="credits[0][sub_code_id]" class="form-control select2" disabled>
                                    <option>@localize('select_subtype')</option>
                                </select>
                                <input type="hidden" name="credits[0][sub_type_id]" value="" />
                            </td>
                            <td>
                                <input type="text" name="credits[0][ledger_comment]" class="form-control text-end"
                                    autocomplete="off" />
                            </td>
                            <td>
                                <input type="number" step="0.01" name="credits[0][amount]" min="1"
