...
class SubLedgerDataTable extends DataTable
{
    use Report;

    public function dataTable($query): DataTableAbstract
    {
        $chart_of_account_id = request()->input('chart_of_account_id') != null ? request()->input('chart_of_account_id') : ChartOfAccount::where('head_level', 4)->where('is_active', 1)->where('is_bank_nature', 1)->first()->id ?? '';
