<x-app-layout>
    <x-card>
        <x-slot name='actions'>
            <a href="{{ route(config('theme.rprefix') . '.index') }}" class="btn btn-primary btn-sm"><i
        ...
        <div>
            <form enctype="multipart/form-data"
                ...
                method="POST" class="needs-validation modal-content" enctype="multipart/form-data">
                @csrf
                @isset($item)
                    @method('PUT')
                @endisset
                <div class=" row">
                    ...
                    <div class="col-md-12 ">
                        <div class="form-group pt-1 pb-1 text-center">
                            <button type="submit" class="btn btn-primary btn-round">@localize('Save')</button>
                        </div>
                    </div>
                </div>
            </form>
