@php
    $count = App\Models\Visitor::getVisitorsCount();
@endphp
<div {{ $attributes->merge(['class' => '']) }}>
    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="112" height="20"
        ...
        <title>@localize('Total Visitor'): {{ $count }}</title>
        ...
        <g clip-path="url(#r)">
            ...
            <rect x="70" width="100" height="20" fill="#4c1" />
        ...
        <g fill="#fff" text-anchor="middle" font-family="Verdana,Geneva,DejaVu Sans,sans-serif"
            ...
            <text aria-hidden="true" x="400" y="150" fill="#010101" fill-opacity=".3" transform="scale(.1)"
                textLength="">@localize('Visitor')</text>
            <text x="400" y="140" transform="scale(.1)" fill="#fff" textLength="">@localize('Visitor')</text>
